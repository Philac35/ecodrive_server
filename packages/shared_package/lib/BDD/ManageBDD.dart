...
import 'package:shared_package/BDD/Interface/ManageBDDInterface.dart';
import 'package:shared_package/BDD/Connection/MysqlConnection.dart';
import 'package:shared_package/BDD/Migration/migrationsRunner.dart';
...
class ManageBDD implements ManageBDDInterface{
 ...
 late  final _log = Logger('orm_mysql');
  ...
  runMigrations(){
    var mysqlMigration=MysqlMigration(connexion as MySQLConnection);
    try{
