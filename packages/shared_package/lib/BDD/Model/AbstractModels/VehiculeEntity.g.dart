...
'brand': {"get":brand,"set":(val) => brand = val}, 
'modele': {"get":modele,"set":(val) => modele = val}, 
'color': {"get":color,"set":(val) => color = val}, 
'energy': {"get":energy,"set":(val) => energy = val}, 
'immatriculation': {"get":immatriculation,"set":(val) => immatriculation = val}, 
'firstImmatriculation': {"get":firstImmatriculation,"set":(val) => firstImmatriculation = val}, 
'nbPlaces': {"get":nbPlaces,"set":(val) => nbPlaces = val}, 
'photoList': {"get":photoList,"set":(val) => photoList = val}, 
