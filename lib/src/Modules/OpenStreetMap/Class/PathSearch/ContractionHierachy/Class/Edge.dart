import 'package:ecodrive_server/src/Modules/OpenStreetMap/Class/GeoDistance.dart';
import './Node.dart';
...
class Edge {
 ...
 late  double weight; //It should be based on distance (haversine formula) , time d*t, or custom (d*penalty factor)
  ...
  Edge({required this. from, required this.to,required Map<int, Node> this.nodeMap,this.weight = 1.0,  this.shortcutWeight, this.isShortcut=false}){
