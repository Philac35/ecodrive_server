...
//Get Coordonneas of point from address TODO implement it correclty.
//Get Coordonneas of a point on the map.
...
class _LocationAppExampleState extends State<SearchExample> {
  ValueNotifier<GeoPoint?> notifier = ValueNotifier(null);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("search picker example")),
      body: Center(
        child: Column(
