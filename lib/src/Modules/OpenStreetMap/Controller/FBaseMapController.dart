...
import 'package:ecodrive_server/src/Modules/OpenStreetMap/Components/Map.dart';
/// class [FBaseMapController] : map controller that will control map by select position,enable current location,
...
@override
class FBaseMapController extends BaseMapController  implements MapControllerInterface<dynamic> {
  late List<GeoPoint> searchedGeopoints;
  ...
  FBaseMapController({
    ...
    super.useExternalTracking,
        ...
        searchedGeopoints =  <GeoPoint>[],
        super(customTile: null);

  FBaseMapController.withPosition({
    required GeoPoint initPosition,
    super.areaLimit = const BoundingBox.world(),
  }) :  searchedGeopoints =  <GeoPoint>[], super(
    initMapWithUserPosition: null,
    initPosition: initPosition,
    customTile: null,
  );

  FBaseMapController.withUserPosition({
    super.areaLimit = const BoundingBox.world(),
  ...
  FBaseMapController.customLayer({
    super.initMapWithUserPosition,
    super.initPosition,
    super.areaLimit = const BoundingBox.world(),
    required CustomTile customTile,
  }) :  searchedGeopoints =  <GeoPoint>[],assert((initMapWithUserPosition != null) || initPosition != null),
        super(customTile: customTile);

  FBaseMapController.cyclOSMLayer({
    super.initMapWithUserPosition,
    super.initPosition,
    super.areaLimit = const BoundingBox.world(),
  }) : assert((initMapWithUserPosition != null) || initPosition != null),
  ...
  FBaseMapController.publicTransportationLayer({
    super.initMapWithUserPosition,
    super.initPosition,
    super.areaLimit = const BoundingBox.world(),
  }) : assert((initMapWithUserPosition != null) || initPosition != null),
